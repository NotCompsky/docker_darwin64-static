...
ENV PATH=$PATH:/usr/local/x86_64-apple-darwin/lib
ENV CC=/usr/local/bin/x86_64-apple-darwin-gcc
ENV CXX=/usr/local/bin/x86_64-apple-darwin-g++
ENV C_INCLUDE_PATH=/usr/local/x86_64-apple-darwin/include
